...
Function add_bar()
    ...
    Dim cmb_btn_code As CommandBarButton
    ...
    Application.VBE.CommandBars("Code Window").Controls("代码对齐").Delete
    On Error GoTo 0
    
    Set cmb_btn_code = Application.VBE.CommandBars("Code Window").Controls.Add(msoControlButton, 1, , 4, 1)
    With cmb_btn_code
        .Caption = "代码对齐"
        .FaceId = 6
    End With
...
'        .Position = msoBarTop
    ...
    Set mybar_event.myevent = Application.VBE.Events.CommandBarEvents(cmb_btn_code)
    only.Add mybar_event
